        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-purple-300">
            {['Audio Production','Vocal Training','Choir Coaching','Piano Lessons',
              ...
              <li key={s} onClick={handleServiceClick} className="hover:text-gold-400 transition-colors cursor-pointer">{s}</li>
            ))}
          </ul>
        </div>
